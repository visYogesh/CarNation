...
const services = [
  {
    ...
    description:
      "Comprehensive auto repair services for all makes and models of vehicles.",
    features: ["Engine diagnostics", "Brake repair", "Transmission service"],
  },
  {
    title: "Oil Change",
    description:
      "Quick and efficient oil change services to keep your engine healthy",
    features: ["Conventional oil", "Synthetic oil", "Filter replacement"],
  },
  {
    title: "Tire Rotation",
    description:
      "Improve tire life and performance with regular rotation services for your vehicle.",
  ...
  },
  {
    ...
    description:
      "Replace your vehicle's alternator to restore charging system functionality.",
    features: [
      "Battery testing",
  ...
  },
  {
    ...
    description:
      "Ensure reliable engine starts by replacing a faulty starter motor.",
    features: [
  ...
  },
  {
    ...
    description:
      "Keep your engine cool with professional water pump replacement.",
    features: [
  ...
  },
  {
    ...
    description:
      "Improve engine performance and fuel efficiency with injector cleaning.",
    features: ["Carbon removal", "Injector testing", "Improved spray pattern"],
  },
  {
    title: "Head Gasket Replacement",
    description:
      "Repair engine leaks and overheating by replacing the head gasket.",
    features: [
  ...
  },
  {
    ...
    description:
      "Restore easy steering with expert power steering system repair.",
    features: ["Fluid replacement", "Pump and hose inspection", "Leak repair"],
  },
  {
    title: "Ignition System Repair",
    description:
      "Fix engine misfires and starting issues with ignition repairs.",
    features: [
  ...
  },
  {
    ...
    description:
      "Maintain smooth turning and traction with differential servicing.",
  ...
  },
  {
    ...
    description:
      "Replace a faulty EGR valve to reduce emissions and improve performance.",
    features: ["Exhaust flow test", "New valve install", "Vacuum hose check"],
  },
  {
    title: "Oxygen Sensor Replacement",
    description:
      "Improve fuel efficiency and reduce emissions with a new O2 sensor.",
    features: [
      "Sensor diagnostics",
      "New O2 sensor install",
  ...
  },
  {
    ...
    description:
      "Restore proper engine timing and performance by replacing the camshaft.",
    features: [
      "Engine disassembly",
      "New camshaft install",
  ...
  },
  {
    ...
    description:
      "Fix engine knocking and vibration with a crankshaft replacement.",
    features: [
      "Bottom end disassembly",
      "New crankshaft install",
      "Bearing replacement",
    ],
  },
  {
    ...
    description:
      "Ensure optimal engine compression and efficiency by adjusting valves.",
    features: [
      "Clearance measurement",
      "Adjustment with feeler gauges",
      "Noise reduction",
    ],
  },
  {
    ...
    description:
      "Restore engine performance with a new or rebuilt cylinder head.",
    features: [
      "Old head removal",
      "New head install",
  ...
  },
  {
    ...
    description:
      "Pass emissions tests and protect the environment with repairs.",
    features: [
  ...
  },
  {
    ...
    description:
      "Prevent overheating by replacing worn or cracked radiator hoses.",
    features: [
      "Coolant drain",
      "New hose install",
      "Clamp and seal inspection",
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Keep your engine at the right temperature with fan replacement.",
    features: [
      "Fan motor install",
      "Relay check",
  ...
  },
  {
    ...
    description:
      "Fix engine overheating and poor heating with a new thermostat.",
    features: [
  ...
  },
  {
    ...
    description:
      "Maintain engine timing and performance with a new timing chain.",
  ...
  },
  {
    ...
    features: [
      "Mount inspection",
      "Rubber or polyurethane options",
      "Secure installation",
    ],
  },
];
