...
//   return (
//     <section  id="blogs" className="py-40 sm:py-40 md:py-40  bg-white">
    ...
    <section id="blogs" className="py-40 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-black max-w-2xl mx-auto">
            Dive into full breakdowns of each service, from detailed
            descriptions to step-by-step features.
          </p>
        </div>
